...
library(janitor)
library(tidycensus)
census_api_key("0600ec02c781c6d55734aaa9086adff6e938f817")
```
...
### Task: Run code (Answer this only)

**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer:** It looks like the middle of Maryland is the primary area where a higher rate of foreclosure notices have occured.
