...
```{r}
library(axolotr)
create_credentials(GROQ_API_KEY = "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")
```
...
```{r}
groq_response <- axolotr::ask(
  prompt = "How can I upload a dataset to R studio?",
  model = "llama-3.1-8b-instant"
)
...
**Your comment:** I believe that the response is appropriate and correct. I like that it offered examples to its suggestions. I think that it is a little overwhelming though, because it offered 7 different options. When using this function I'll try to make my questions more specific to get less results.
