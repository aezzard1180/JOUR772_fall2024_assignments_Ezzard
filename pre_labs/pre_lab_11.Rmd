...
### Task 14: Load the bing lexicon and produce sentiments for our 2022 and 2024 unique words (answer this only)

**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** From the 2022 list, one word that I see that may be incorrect is "urgent." I wouldn't say that that word really has a negative meaning, or really any emotional meaning. Being urgent is just acting quickly which really doesn't have a sentiment associated with it. Another word from the 2022 list that has an interesting sentiment is the word "hot." To me this word kind of holds a negative sentiment rather than positive because the feeling of being hot is uncomfortable and in some cases it can be attributed to a fever. From the 2024 list, one word that I noticed might be incorrect is the sentiment for the word "competitive." The list has it labeled as positive, though I kind of think of it as a negative word. A second word that I wanted to mention from the 2024 list is "complex." It was labeled as having a negative sentiment, though I don't really think this word has a negative or positive meaning. Something being complex isn't necessarily a bad thing.
