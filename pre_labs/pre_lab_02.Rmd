...
1.  From the Maryland expenditure, I would like to know, for Maryland only, how much in total was spent on media alone. Scrolling through the table, media pops up a lot and I'm just curious as to how much out of the whole sum is spent on media.

2.  From the Maryland expenditure, I would like to know which zip code in Maryland only, spent the most compared to other zip codes in that state.

3.  From the Maryland expenditure, still for only Maryland, I would like to see which committee spent the least amount of money.
