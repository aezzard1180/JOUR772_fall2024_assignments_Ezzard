...
### Task 7: Correlate data (Answer this only)

**Task** Run the following code. Describe the model output. What do you see? **Answer** I see that the p-value is higher at 0.6795 compared to the previous task which had a p-value of 0.00301. The r-value from this task is lower at -0.06 compared to the previous task's r-value which is at -0.41. For this task, the values indicate that there really isn't a significant correlation between the two datasets.
