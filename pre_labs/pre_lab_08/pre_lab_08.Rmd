...
### Task 10: Run the following code (Answer this only)
...
**Answer** The chart gained color in the background, so now the bars stand out a little more. Also the county names and count numbers are a little bigger. The graph only has horizontal lines as well.
