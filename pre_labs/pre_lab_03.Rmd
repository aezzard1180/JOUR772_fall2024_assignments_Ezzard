...
cleaned_md_grants_loans |>
  filter(str_detect(source, "MARYLAND TOURISM BOARD")) |>
   group_by(source, "MARYLAND TOURISM BOARD", zip5, amount) |>
  summarise(
    total_amount = n()
  ) |>
  arrange(desc(amount))
...
**A** The zip code that has received the most money is 21202. This zip code is not surprising to me because the Maryland Tourism board is housed in this zip code.
