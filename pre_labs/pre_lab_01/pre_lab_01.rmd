...
1.  I would ask it to give me the number of courses for each department per semester. (Fall 2023, Spring 2024, etc.) I am curious to see the fluctuations in offerings for some classes and explore why a course isn't offered at a certain time.

2.  I would also ask it to show me what classes have the most vs least open seats. I am curious to see which classes seem to be popular to students and which aren't so much. There could be a problem with the instructor teaching it or just no interest. If there's no interest then maybe more room can open up for another class.

3.  I would ask it to show me which department offers the most classes. I'm curious to see which department offers the most diversity in classes. Do they offer more classes because the department size is huge, or do they have many classes that could allow for a student to be exposed to a lot of content that maybe another school doesn't offer.
