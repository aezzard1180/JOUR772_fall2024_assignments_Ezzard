...
fentanyl_deaths <- read_csv("tabula-Annual_2020_Drug_Intox_Report.csv", col_names = FALSE) |> 
  clean_names() |> 
  rename(jurisdiction = x1, deaths_2012 = x2, deaths_2013 = x3, deaths_2014 = x4, deaths_2015 = x5, deaths_2016 = x6, deaths_2017 = x7, deaths_2018 = x8, 
         deaths_2019 = x9, deaths_2020 = x10, deaths_total = x11)
