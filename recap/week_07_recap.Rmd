...
**A2: There are 9186 records. You can gather the time an earthquake occurred, the location, depth and magnitude.**
...
**A3: The depth is 628.362 and the magnitude is 4.6.**
...
**A4: There are 6 earthquakes that fit this criteria.**
...
**A5: There are 4 observations that fit both criteria.**
...
**A6: There are 7,475 observations that fit this criteria.**
...
**A7: 2,168 earthquakes occurred there.**
...
**A8: Two most common types are an earthquake and a quarry blast.**
...
**A9: The average depth of earthquakes is 19.4.**
